...
thrplototb <- reactive({
  ...
  p1 <- show_thrplot(epcdata, bay_segment = "OTB", thr = "chla", trgs = trginps, yrrng = c(1975, maxyr)) + 
    ggtitle(NULL) +
    pthm
  p2 <- show_thrplot(epcdata, bay_segment = "OTB", thr = "la", trgs = trginps, yrrng = c(1975, maxyr)) + 
    ggtitle(NULL) + 
    pthm
...
thrplothb <- reactive({
  ...
  p1 <- show_thrplot(epcdata, bay_segment = "HB", thr = "chla", trgs = trginps, yrrng = c(1975, maxyr)) + 
    ggtitle(NULL) +
    pthm
  p2 <- show_thrplot(epcdata, bay_segment = "HB", thr = "la", trgs = trginps, yrrng = c(1975, maxyr)) + 
    ggtitle(NULL) +
    pthm
...
thrplotmtb <- reactive({
  ...
  p1 <- show_thrplot(epcdata, bay_segment = "MTB", thr = "chla", trgs = trginps, yrrng = c(1975, maxyr)) + 
    ggtitle(NULL) +
    pthm
  p2 <- show_thrplot(epcdata, bay_segment = "MTB", thr = "la", trgs = trginps, yrrng = c(1975, maxyr)) + 
    ggtitle(NULL) +
    pthm
...
thrplotltb <- reactive({
  ...
  p1 <- show_thrplot(epcdata, bay_segment = "LTB", thr = "chla", trgs = trginps, yrrng = c(1975, maxyr)) + 
    ggtitle(NULL) +
    pthm
  p2 <- show_thrplot(epcdata, bay_segment = "LTB", thr = "la", trgs = trginps, yrrng = c(1975, maxyr)) + 
    ggtitle(NULL) +
    pthm
...
attmat <- reactive({
  ...
  out <- show_matrix(epcdata, trgs = trginps, yrrng = c(1975, maxyr)) + 
    theme(
