...
selplo <- reactive({
  ...
  p3 <-  plot_ly(algplo, x = ~ yrqrt, y= ~count, color = ~name) %>% 
    add_bars() %>% 
    layout(
...
Click the buttons below to download water quality and phytoplankton cell count data. Select all data or specific stations. 
